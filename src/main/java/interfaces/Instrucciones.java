	...
	public Instrucciones(Ventana v) {
		...
		textito.append(
				"\nBIENVENIDO A CARD FIGHTERS, EN ESTA PANTALLA TE CONTARÉ CÓMO FUNCIONAN LAS MECÁNICAS DE JUEGO, PARA EMPEZAR,\n"
						...
						+ "\r\n"
						+ "TODOS LOS PERSONAJES TIENEN 20 PUNTOS DE VIDA Y UN MÁXIMO DE 5 PUNTOS DE ENERGÍA. CUANDO EMPIECE EL\n "
						...
						+ "     BLOQUEO.BLOQUEO ES UNA DE LAS CARTAS MÁS CRUCIALES EN EL COMBATE, ESTA CARTA SIEMPRE IRÁ ANTES QUE \n"
						+ "     CUALQUIERA Y BLOQUEARÁ POR COMPLETO EL GOLPE DE TU RIVAL Y NO RECIBIRÁS DAÑO.\r\n"
						+ "\r\n"
