	...
	public Instrucciones(Ventana v) {
		...
		textito.append(
				"\nBIENVENIDO A CARD FIGHTERS, EN ESTA PANTALLA TE CONTARÉ CÓMO FUNCIONAN LAS MECÁNICAS DE JUEGO, PARA EMPEZAR,\n"
						+ "EN EL MAPA TU PERSONAJE ESTARÁ REPRESENTADO POR UN ICONO NEGRO Y EL DEL RIVAL POR UNO ROJO, VUESTRA\n"
						+ "VIDA ESTARÁ EN COLOR ROJO Y VUESTRA ENERGÍA RESTANTE EN COLOR AZUL\n\n"
						...
						+ "\r\n"
						+ "     - TIPO BÁSICO: SON CARTAS COMUNES QUE TANTO TÚ COMO TU RIVAL POSEEIS, SON PUÑETAZO, ACOMETIDA Y \n"
						+ "     BLOQUEO.\n\n"
						...
						+ "     EL RIVAL ATACARÁ PRIMERO SIEMPRE QUE ÉL NO SUFRA TAMBIÉN UN ESTADO DE INCAPACITACIÓN POR EL USO DE\n"
						+ "     UNA CARTA CON UN COSTE DE ENERGÍA O DE VIDA QUE NO PUEDA PAGAR, ASÍ QUE PIENSA BIEN QUÉ CARTA USAS\n"
						+ "     ANTES DE ELEGIRLA.\n\n"
						...
						+ "     SUPONGAMOS QUE ENTRE TU RIVAL Y TÚ HAY 3 DE DISTANCIA, TÚ UTILIZAS 'HADOUKEN' Y TU RIVAL USA 'ACOMETIDA'\n"
						...
						+ "     TU CARTA'HADOUKEN' SÍ QUE ESTÁ EN SU RANGO DE IMPACTO, ASÍ QUE EN ESTE CASO GANARÍAS EL INTERCAMBIO.\n "
						...
						+ "¿QUÉ PASA SI ME QUEDO SIN CARTAS?\n\n"
						+ "     TANTO EL RIVAL COMO TÚ USAIS CARTAS A LO LARGO DEL COMBATE, SI SE TE ACABAN LAS CARTAS PERDERÁS\n"
